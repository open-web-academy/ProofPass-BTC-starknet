...
function forceV06(provider) {
    const ch = provider.channel;
    // In starknet.js v6, we can hijack the fetch to force version 0x2/0x1 fields
    ...
    console.log('✅ Provider forced to v0.6 Spec level');
}

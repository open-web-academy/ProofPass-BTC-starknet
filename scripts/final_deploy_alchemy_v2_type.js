...
async function main() {
    console.log('--- RAW STARKNET PURE V2/V1 DEPLOYMENT (Alchemy + Type) ---\n');
    ...
    for (const name of contracts) {
        ...
        if (classCheck.result) {
            ...
            process.stdout.write(`  Declaring (version 2, nonce 0x${nonceValue.toString(16)})...`);

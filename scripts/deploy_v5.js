const { RpcProvider, Account, json, hash, num } = require('starknet');
const fs = require('fs');
const path = require('path');

// Alchemy v0.7 RPC URL
const RPC = 'https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_7/MnGSA2Mjm9SFFPUCuXWdP';
...
async function main() {
    ...
    const strToHex = (str) => '0x' + Buffer.from(str).toString('hex');
